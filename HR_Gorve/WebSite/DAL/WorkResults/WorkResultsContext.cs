...
namespace DAL.WorkResults
{
    public class WorkResultsContext : DataContext
    {
        ...
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate, SupId, Auditor, AuditResult, ShopCode, AreaId, ProvinceId, DistrictId, TownId, MVOId, POGId, QCStatus, LWorkId, PageNumber, RowNumber);
        }
        ...
        [Function(Name = "[dbo].[Report.Attendance]")]
        public DataSet ReportAttendance(int LoginId, DateTime FromDate, DateTime ToDate)
        {
            return ExecuteDataset((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate);
        }
        ...
        public DataTable WorkResultGetKPIPOSM(long WorkId, int ShowAll = 0)
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), WorkId, ShowAll);
        }
        ...
        [Function(Name = "[dbo].[BillResult.GetList]")]
        public DataTable BillResultGetList(int LoginId, DateTime FromDate, DateTime ToDate,
            int AreaId, int ProvinceId, int DistrictId, int TownId, int? Site, string ShopCode, string Mobile, string ProductCode, string BillSeri,
           int? PageNumber, int? RowNumber)
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate, AreaId, ProvinceId, DistrictId, TownId, Site, ShopCode, Mobile, ProductCode, BillSeri, PageNumber, RowNumber);
        }
        [Function(Name = "[dbo].[BillResult.Export]")]
        public DataTable BillResultExport(int LoginId, DateTime FromDate, DateTime ToDate,
            int AreaId, int ProvinceId, int DistrictId, int TownId, int? Site, string ShopCode, string Mobile, string ProductCode, string BillSeri)
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate, AreaId, ProvinceId, DistrictId, TownId, Site, ShopCode, Mobile, ProductCode, BillSeri);
        }
    }
}
