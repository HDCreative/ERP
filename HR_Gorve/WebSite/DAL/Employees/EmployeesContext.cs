...
namespace DAL.Employees
{
    public class EmployeesContext : DataContext
    {
        ...
        [Function(Name = "[dbo].[UserLeave.GetList]")]
        public DataTable UserLeaveGetList(int LoginId, DateTime FromDate, DateTime? ToDate, int? SupId, int? AuditorId, int Status, int PageNumber, int RowPerPage)
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate, SupId, AuditorId, Status, PageNumber, RowPerPage);
        }
        [Function(Name = "[dbo].[UserOT.GetList]")]
        public DataTable UserOTGetList(int LoginId, DateTime FromDate, DateTime? ToDate, int? SupId, int? AuditorId, int Status, int PageNumber, int RowPerPage)
        {
            return ExecuteDatatable((MethodInfo)MethodBase.GetCurrentMethod(), LoginId, FromDate, ToDate, SupId, AuditorId, Status, PageNumber, RowPerPage);
        }
    }
