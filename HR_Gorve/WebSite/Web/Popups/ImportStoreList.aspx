<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportStoreList.aspx.cs" Inherits="HR_Grove_Web.Popups.ImportStoreList" %>
                    ...
                    <div class="container-fluid">
                        <div class="card card-info">
                            <div class="card-body">
                                ...
                                <label style="color: red; font-style: italic;">Lưu ý : Loại nhập liệu 'CẬP NHẬT' nếu thêm mới thì để ShopCode trong file và nếu cập nhật thì để ShopId hệ thống.</label>
                            </div>
