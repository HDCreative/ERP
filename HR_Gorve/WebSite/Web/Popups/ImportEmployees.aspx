<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportEmployees.aspx.cs" Inherits="HR_Grove_Web.Popups.ImportEmployees" %>
                ...
                <div class="container-fluid">
                    <div class="card card-info" style="margin-bottom: 0px !important;">
                        <div class="card-header">
                            <h3 class="card-title">
                                <asp:Label Text="Nhập liệu nhân viên" runat="server" /></h3>
                    ...
                    <div class="container-fluid">
                        <div class="card card-info">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" CssClass="form-control select2 select2-hidden-accessible" ID="ddlType">
                                                <asp:ListItem Text="Thêm mới" Value="1" />
                                                <asp:ListItem Text="Cập nhật" Value="2" />
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <label style="color: red; font-style: italic;">Lưu ý : Loại nhập liệu 'CẬP NHẬT' nếu thêm mới thì để EmployeeCode trong file và nếu cập nhật thì để EmployeeId hệ thống.</label>
                                <br />
                                <label style="color: red; font-style: italic;">Lưu ý : Password mặc định khi Import từ file excel là 'audit@2022'.</label>
                            </div>
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <asp:Button runat="server" class="btn btn-danger" Text="Template" ID="btnTemplate" OnClick="btnTemplate_Click" UseSubmitBehavior="false"
                                            OnClientClick="this.value='Đang nhập liệu...'; this.disabled='true'" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Import nhân viên</h3>
                                    </div>
                                    <div class="card-body">
