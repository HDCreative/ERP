<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAudit.Master" AutoEventWireup="true" CodeBehind="DigitalMapAudit.aspx.cs" Inherits="HR_Grove_Web.DigitalMapAudit" %>
                ...
                <div class="card-header" style="display:block !important;">
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="text-align: left; width: 200px; font-weight: bold;">Tổng số: 500 CH </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label id="lbbt" for="cbbt" class="custom-control-label">CH: 500 CH</label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td style="text-align: left;">
                                <table>
                                    <tr>
                                        <td>
                                            <img src="Images/map_red.png" />
                                            <label style="vertical-align: sub;" id="lbchoose">: 0 CH</label>
                                        </td>
                                        <td style="padding-left: 10px;">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" onchange="return viewmap();" type="checkbox" id="cboos" value="option1">
                                                <label for="cboos" class="custom-control-label">Rớt</label>
                                            </div>
                                        </td>
                                       <%-- <td style="padding-left: 10px;">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" onchange="return viewmap();" type="checkbox" id="cbsos" value="option1">
                                                <label for="cbsos" class="custom-control-label">Rớt vì đối thủ</label>
                                            </div>
                                        </td>
                                        <td style="padding-left: 10px;">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" onchange="return viewmap();" type="checkbox" id="cbso" value="option1">
                                                <label for="cbso" class="custom-control-label">Rớt do POSM </label>
                                            </div>
                                        </td>
                                        ...
                                        <td style="padding-left: 10px;">
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="cbar" class="custom-control-label">Đạt T/Bày </label>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div class="card card-primary card-outline card-tabs">
                                    <div class="card-header p-0 pt-1">
                                        <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="tabaudit_tab" data-toggle="pill" href="#tabaudit" onclick="return tab_audit()" role="tab" aria-controls="tabaudits" aria-selected="true">AUDIT</a>
                                            </li>

                                            <li class="nav-item" style="display:none;">
                                                <a class="nav-link" id="tabfieldforce_Tab" data-toggle="pill" href="#tabfieldforce" role="tab" aria-controls="tabfieldforce" aria-selected="false">DOANH SỐ</a>
                                            </li>
                                            <li class="nav-item">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show" id="tabfieldforce" role="tabpanel" aria-labelledby="tabfieldforce">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="card">
                                            ...
                                            <div class="tab-pane fade show active" id="tabaudit" role="tabpanel" aria-labelledby="tabhrm">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            <div class="card-header ui-sortable-handle" style="cursor: move; background-color: #00bcd4;">
                                                                <p class="card-title" style="color: white; font-weight: bold;">
                                                                    Kết quả trưng bày 10 lần gần nhất
                                                                </p>
                                                            </div>
                                                            <div class="card-body" style="height: 340px; overflow-y: auto;">
                                                                <table class="table" style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>23/03/2022</td>
                                                                        <td>Trần Văn A</td>
                                                                        <td><span class="badge bg-yellow">KTC - Đóng cửa do Covid</span></td>
                                                                        <td>Gói Sourth 1</td>
                                                                        <td>Sales A</td>
                                                                        <td>Sales SUP B</td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>23/03/2022</td>
                                                                        <td>Trần Văn A</td>
                                                                        <td><span class="badge bg-danger">TC- Rớt</span></td>
                                                                        <td>Gói Sourth 1</td>
                                                                        <td>Sales A</td>
                                                                        <td>Sales SUP B</td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td>23/03/2022</td>
                                                                        <td>Trần Văn A</td>
                                                                        <td><span class="badge bg-success">TC- Đạt</span></td>
                                                                        <td>Gói Sourth 1</td>
                                                                        <td>Sales A</td>
                                                                        <td>Sales SUP B</td>
                                                                    </tr>
                    ...
                    if (_maprado == 0) {
                        if (data && data.length && data.length > 0) {
                            ...
                            for (var j = 0; j < data.length; j++) {
                                ...
                                if (data[j].icon == '../images/map_red.png')
                                    count_choose++;
                            }

                            $('#lbchoose').text(": " + count_choose + " CH");
                            $('#lbbt').text("CH : " + (500 - count_choose) + " CH");
                        }
                    }
