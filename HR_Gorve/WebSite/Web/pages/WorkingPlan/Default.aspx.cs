...
namespace HR_Grove_Web.pages.WorkingPlan
{
    public partial class Default : PagePermisstion
    {
        private string _title = "Workingplan manager";
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            {
                Toastr.WarningToast("Vui lòng chọn Quản lý !");
                return;
            }
        ...
        private void AddData(bool IsAll = false)
        {
            ...
            int AuditorId = ddlAuditor.SelectedIndex > 0 ? Convert.ToInt32(ddlAuditor.SelectedValue) : Convert.ToInt32(ddlSup.SelectedValue);
            try
            {
