<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAudit.Master" AutoEventWireup="true" CodeBehind="EmployeeShops.aspx.cs" Inherits="HR_Grove_Web.pages.Employees.EmployeeShops" %>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Button ID="btnImport" CssClass="btn btn-danger" runat="server" Text="Thêm dữ liệu" OnClientClick="popWindow_Custom('/Popups/ImportEmployeeStore.aspx', 700, 520); return false;" />
