<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuditMer.aspx.cs" Inherits="HR_Grove_Web.Report.AuditMer" %>
                                                                    ...
                                                                    <div class="card card-primary card-outline card-tabs">
                                                                        <div class="card-header p-0 pt-1 border-bottom-0">
                                                                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                                                                ...
                                                                                <li class="nav-item">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="SURVEY" ID="lbSURVEY" OnClick="lbKPI_Click">PlanOgram</asp:LinkButton>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                ...
                                                                                <li class="nav-item">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="IVT" ID="lbIVT" OnClick="lbKPI_Click">C.Trình TB khác</asp:LinkButton>
                                                                                </li>
                                                                                <li class="nav-item">
                                                                                    ...
                                                                                    <table class="table">
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="text-align: center;">1</td>
                                                                                                    <td style="text-align: center;">POSM 1</td>
                                                                                                    <td style="text-align: center;">Có</td>
                                                                                                    <td style="text-align: center;">Có hư hỏng</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="text-align: center;">2</td>
                                                                                                    <td style="text-align: center;">POSM 2</td>
                                                                                                    <td style="text-align: center;">Có</td>
                                                                                                    <td style="text-align: center;">Còn mới</td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td style="text-align: center;">3</td>
                                                                                                    <td style="text-align: center;">POSM 3</td>
                                                                                                    <td style="text-align: center;"><span class="badge bg-danger">Không có</span></td>
                                                                                                    <td style="text-align: center;"></td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                     <td style="text-align: center;">4</td>
                                                                                                    <td style="text-align: center;">POSM 4</td>
                                                                                                    <td style="text-align: center;">Có</td>
                                                                                                    <td style="text-align: center;">Còn mới</td>
                                                                                                </tr>
                                                                                            </tbody>
