import 'package:mutosi/app/base/BaseInfo.dart';
...
class ShopInfo extends BaseInfo {
  ...
  String getIcon() {
    if (locked != null) {
      if (isUpload != null && isUpload) {
        return 'assets/icons/ic_upload_done.png';
      } else {
        return 'assets/icons/ic_check_done.png';
      }
    } else {
      return 'assets/icons/ic_shop.png';
    }
  }
  ...
  ShopInfo.fromMap(Map<String, dynamic> map) {
    ...
    salesName = map["salesName"];
    salesPhone = map["salesPhone"];
