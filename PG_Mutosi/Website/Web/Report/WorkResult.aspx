<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAudit.Master" AutoEventWireup="true" CodeBehind="WorkResult.aspx.cs" Inherits="Mutosi_Web.Report.WorkResult" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList runat="server" ID="ddlTypeReport" Style="width: 150px; height: 37px; float: right; margin-right: 20px;">
                                ...
                                <asp:ListItem Text="Khảo sát SL nhân viên + hình ảnh ST" Value="7" />
                                <asp:ListItem Text="Khảo sát quà đầu ca" Value="8" />
                                <asp:ListItem Text="Khảo sát quà cuối ca" Value="9" />
                                                            ...
                                                            <tr style="height: 40%">
                                                                <td colspan="100%" style="padding: 0px !important;">
                                                                    ...
                                                                    <div class="card card-primary card-outline card-tabs">
                                                                        <div class="card-header p-0 pt-1 border-bottom-0">
                                                                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                                                                ...
                                                                                <li class="nav-item" runat="server" id="li_surveynumofemp">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="SURVEYNUMOFEMP" ID="lbSURVEYNUMOFEMP" OnClick="lbKPI_Click">KS SL nhân viên</asp:LinkButton>
                                                                                </li>
                                                                                <li class="nav-item" runat="server" id="li_surveyfistgift">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="SURVEYFISTGIFT" ID="lbSURVEYFISTGIFT" OnClick="lbKPI_Click">KS quà đầu ca</asp:LinkButton>
                                                                                </li>
                                                                                <li class="nav-item" runat="server" id="li_surveylastgift">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="SURVEYLASTGIFT" ID="lbSURVEYLASTGIFT" OnClick="lbKPI_Click">KS quà cuối ca</asp:LinkButton>
                                                                                </li>
                                                                                <%--<li class="nav-item" runat="server" id="li_storeimage">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="STOREIMAGE" ID="lbSTOREIMAGE" OnClick="lbKPI_Click">Hình ảnh ST</asp:LinkButton>
                                                                                </li>--%>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                    <asp:Panel runat="server" ID="pnGrid" Visible="false">
                                                                                        ...
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th class="text-center">T/tế | 
                                                                                                        <asp:CheckBox runat="server" ID="cbAllOSA" Text="Tất cả" AutoPostBack="true" OnCheckedChanged="cbAllOSA_CheckedChanged" /></th>
                                                                                                    <th class="text-center" <%# IsViewDataAdmin ==true || IsEditDataAdmin ==true  ? "''":"style='display:none'" %>>T/tế Admin</th>
                                                                                                    <th class="text-center" <%# IsViewDataAuditer ==true ?"''": "style='display:none'"  %>>T/tế Auditer  </th>
                                                                                                </tr>
                                                                                            </thead>
                                                                                            <tbody>
                                                                                                <asp:Repeater runat="server" ID="rptOSA">
                                                                                                    <ItemTemplate>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td <%# IsViewDataAdmin ==true || IsEditDataAdmin ==true  ? "style='text-align: center;'": "style='display:none;text-align: center;'" %>>
                                                                                                                <%#(IsEditDataAdmin == true && Eval("IsLockReport").ToString() == "0" && Eval("QCStatus").ToString() != "5")
                                                                                                                         ?"<input class='edit_textbox' id='"+Eval("WorkId") +"_2_" + Eval("ProductId")+"' data-valueold='"+Eval("BM_OSAValue")+"' data-workid='"+Eval("WorkId")+"' data-kpiid='2' data-itemid='"+Eval("ProductId")+"' min='0' max='99' style='width:150px;' value='"+Eval("BM_OSAValue")+"' type='number' placeholder='"+ (Eval("Brand").Equals("SURVEY") ?"Nhập số =0 or =1":"Nhập số >=0,<100")+"'  />"
                                                                                                                         :"" %>
                                                                                                                ...
                                                                                                                <span <%# IsViewDataAdmin ==true || Eval("IsLockReport").ToString()=="1" || Eval("QCStatus").ToString() == "5" ?"style='text-align: center;'": "style='display:none;text-align: center;'"  %> class='<%# Eval("BM_OSAValue").ToString().Contains("KĐạt") || Eval("BM_OSAValue").ToString().Contains("0")?"badge bg-danger":"" %>'><%# Eval("BM_OSAValue") %></span>
                                                                                                            </td>
                                                                                                            <td <%# IsViewDataAuditer ==true ?"style='text-align: center;'": "style='display:none;text-align: center;'"  %>>
                                                                                                                <span class='<%# Eval("Audit_OSAValue").ToString().Contains("KĐạt") || Eval("Audit_OSAValue").ToString()=="0"?"badge bg-danger":"" %>'><%# Eval("Audit_OSAValue") %></span>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </ItemTemplate>
                                                                                                </asp:Repeater>
                                                                                        ...
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            <thead>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <th class="text-center">Chỉ tiêu</th>
                                                                                                    <th class="text-center">Thực tế |
                                                                                                        <asp:CheckBox runat="server" ID="cbAllPosm" Text="Tất cả" AutoPostBack="true" OnCheckedChanged="cbAllPosm_CheckedChanged" /></th>
                                                                                                    </th>
                                                                        ...
                                                                        <%-- Tab Survey POSM --%>
                                                                        <asp:Panel runat="server" ID="plSURVEYPOSM" Visible="false">
                                                                            <div class="row">
                                                                                <div class="col-sm-6" style="height: 550px; overflow-y: scroll">
                                                                                    <table class="table table-bordered">
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <asp:Repeater runat="server" ID="rptSURVEYPOSM">
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            <td style="text-align: center;"><%# Eval("RN") %></td>
                                                                                                            <td style="text-align: center;"><%# Eval("SurveyName") %></td>
                                                                        ...
                                                                        <%-- Tab Survey Number of employees --%>
                                                                        <asp:Panel runat="server" ID="plSURVEYNUMOFEMP" Visible="false">
                                                                            <div class="row">
                                                                                <div class="col-sm-6" style="height: 550px; overflow-y: scroll">
                                                                                    <table class="table table-bordered">
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <asp:Repeater runat="server" ID="rptSURVEYNUMOFEMP">
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            <td style="text-align: center;"><%# Eval("RN") %></td>
                                                                                                            <td style="text-align: center;"><%# Eval("SurveyName") %></td>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="images">
                                                                                        <iframe src="ReportPhoto.aspx?WorkId=<%# Eval("WorkId") %>&KPIId=7" frameborder='0' frameborder='0' scrolling='yes' width='750px' height='600px'></iframe>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </asp:Panel>
                                                                        <%-- Tab Survey First Gift In Shift --%>
                                                                        <asp:Panel runat="server" ID="plSURVEYFISTGIFT" Visible="false">
                                                                            <div class="row">
                                                                                <div class="col-sm-6" style="height: 550px; overflow-y: scroll">
                                                                                    <table class="table table-bordered">
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <asp:Repeater runat="server" ID="rptSURVEYFISTGIFT">
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            <td style="text-align: center;"><%# Eval("RN") %></td>
                                                                                                            <td style="text-align: center;"><%# Eval("SurveyName") %></td>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="images">
                                                                                        <iframe src="ReportPhoto.aspx?WorkId=<%# Eval("WorkId") %>&KPIId=8" frameborder='0' frameborder='0' scrolling='yes' width='750px' height='600px'></iframe>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </asp:Panel>
                                                                        <%-- Tab Survey Last Gift In Shift --%>
                                                                        <asp:Panel runat="server" ID="plSURVEYLASTGIFT" Visible="false">
                                                                            <div class="row">
                                                                                <div class="col-sm-6" style="height: 550px; overflow-y: scroll">
                                                                                    <table class="table table-bordered">
                                                                                        <tr style="text-align: left; vertical-align: top">
                                                                                            ...
                                                                                            <tbody>
                                                                                                <asp:Repeater runat="server" ID="rptSURVEYLASTGIFT">
                                                                                                    <ItemTemplate>
                                                                                                        <tr>
                                                                                                            <td style="text-align: center;"><%# Eval("RN") %></td>
                                                                                                            <td style="text-align: center;"><%# Eval("SurveyName") %></td>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="images">
                                                                                        <iframe src="ReportPhoto.aspx?WorkId=<%# Eval("WorkId") %>&KPIId=9" frameborder='0' frameborder='0' scrolling='yes' width='750px' height='600px'></iframe>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </asp:Panel>
                                                                                ...
                                                                                <div class="card-footer">
                                                                                    <div class="row">
                                                                                        <div class="col-md-2">
                                                                                            ...
                                                                                            <asp:TextBox CssClass="form-control" TextMode="Password" runat="server" ID="txtKey" placeholder="Password"></asp:TextBox>
                                                                                        </div>
                                                                                        <div class="col-md-4">
