<%@ Page Title="" Language="C#" MasterPageFile="~/SiteAudit.Master" AutoEventWireup="true" CodeBehind="WorkResult.aspx.cs" Inherits="VNPay_Web.Report.WorkResult" %>
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList runat="server" ID="ddlTypeReport" Style="width: 150px; height: 37px; float: right; margin-right: 20px;">
                               ...
                               <%-- <asp:ListItem Text="HOTZONE" Value="1" />
                                ...
                                <asp:ListItem Text="POSM" Value="8" />
                                                                    ...
                                                                    <div class="card card-primary card-outline card-tabs">
                                                                        <div class="card-header p-0 pt-1 border-bottom-0">
                                                                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                                                                ...
                                                                                <li class="nav-item" runat="server" id="li_surveyposm">
                                                                                    <asp:LinkButton runat="server" class="nav-link" CommandName="SURVEYPOSM" ID="lbSURVEYPOSM" OnClick="lbKPI_Click">Khảo sát lắp đặt POSM</asp:LinkButton>
                                                                                </li>
