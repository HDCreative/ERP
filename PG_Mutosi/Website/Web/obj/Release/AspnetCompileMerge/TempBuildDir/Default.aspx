<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="VNPay_Web._Default" %>
...
<head>
    ...
    <title>Syngenta Audit | Log in (v2)</title>
...
<body class="hold-transition login-page" style="background-image: url(../images/vnpay.png);
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <img style="padding: 10px;" src="https://vnpay.vn/_nuxt/img/logo-primary.55e9c8c.svg" />
            ...
            <table style="text-align:center;">
                <tr>
                    <td>
                        <a href="https://syngenta.e-technology.vn/Services/Android/android.html">
