...
namespace SMI.DAUltility.Helper
{
    public static class RecruitmentHelper
    {
        ...
        /// <summary>
        /// Method used to get string connection from registry.
        /// </summary>
        /// <param name="pDBName">Name of connection which connect.
        /// This name saved in registry.
        /// </param>
        /// <returns>String connection to connect to database.</returns>
        public static string getConnectionString(string pDBName)
        {
            //Object to get ServerDB of connection
            object objServerDB;
            //Object to get UserID of connection
            object objUserID;
            //Object to get PassWord of connection
            object objPassWord;
            //Object to get DatabaseName of connection
            object objDatabaseName;

            try
            {
                //Open key in registry to get property of connection
                RegistryKey currentMachine = Registry.LocalMachine;
                RegistryKey software = currentMachine.OpenSubKey("SOFTWARE");
                RegistryKey cyMed = software.OpenSubKey(pDBName);
                RegistryKey dataServices = cyMed.OpenSubKey("DataServices");
                RegistryKey fwConnections = dataServices.OpenSubKey("FWConnections");
                //Get Property of connection from Registry.
                objServerDB = fwConnections.GetValue("ServerDB");
                objUserID = fwConnections.GetValue("UserID");
                objPassWord = fwConnections.GetValue("PassWord");
                objDatabaseName = fwConnections.GetValue("DatabaseName");
                sConnString = "server=" + objServerDB + ";uid=" + objUserID + ";pwd=" + objPassWord + ";database=" +
                              objDatabaseName + ";";
                //Return string connection to connect to database.
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        /// <summary>
        /// Method used to get string connection from web configuration.
        /// </summary>
        /// This name saved in registry.
        /// </param>
        /// <returns>String connection to connect to database.</returns>
        public static string getConnectionString()
        {
            try
            {
                sConnString = ConfigurationManager.ConnectionStrings["connStr2"].ConnectionString;
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        {
            SqlConnection lConn = new SqlConnection(connectionstring);
            lConn.Open();
            return lConn;
        }
        #endregion
        ...
        public static SqlParameter CreateParameter(SqlParameter param, object value)
        {
            param.Value = value;
            return param;
        }
        public static SqlParameter CreateParameter(string fieldName, DbType? dbtype, object value)
        {
            SqlParameter _item = new SqlParameter(fieldName, value);
            if (dbtype != null)
                _item.DbType = (DbType)dbtype;
            return _item;
        }
        public static SqlParameter CreateParameter(string fieldName, DbType? dbtype, int length, object value)
        {
            SqlParameter _item = new SqlParameter(fieldName, value);
            if (dbtype != null)
                _item.DbType = (DbType)dbtype;
