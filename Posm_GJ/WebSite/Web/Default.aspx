...
<head>
    ...
    <title>Posm Gojek | Log in (v2)</title>
...
<body class="hold-transition login-page" style="background-image: url(&quot;https://blog.gojek.io/content/images/size/w2000/2021/03/Tale-of-two-lambdas.jpeg&quot;); background-size: 100% 100%; position: fixed; z-index: -10000; inset: 0px; min-height: 435.918px;">
    <div class="login-box">

        <!-- /.login-logo -->
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <img style="padding:10px;" src="https://lelogama.go-jek.com/service_icon_text/gojek-logo_normal.svg">
            ...
            <table style="text-align: center;">
                <tr>
                    <td>
                        <a href="https://gojek.e-technology.vn/Services/Android/android.html">
                            <img src="Images/icon_android.png" style="width: 100px" /></a>

                    </td>
                    <td>
                        <%--<img src="Images/icon_ios.png" style="width:100px" />--%>
                        <a href="https://testflight.apple.com/join/L1WhrIx1">
