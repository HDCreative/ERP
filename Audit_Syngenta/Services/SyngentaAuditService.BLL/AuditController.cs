...
namespace SyngentaAuditService.BLL
{
    public class AuditController
    {
        ...
        public static int InsertData(int? ShopId,int? WorkDate,string WorkTime,int EmployeeId,int? ShopFormatId,int? AuditResult,int? ShopType,string Comment, DataTable _tbAttendant , DataTable _tbPhoto , DataTable _tbAudio , DataTable _tbOSA , DataTable _tbPosm , DataTable _tbSurveyResult , DataTable _tbSurveyDetailResult)
        {
