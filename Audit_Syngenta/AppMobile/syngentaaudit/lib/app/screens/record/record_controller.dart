...
import 'package:flutter_sound_platform_interface/flutter_sound_recorder_platform_interface.dart' as fspi;
  ...
  Future<void> play(AudioInfo file) async {
    if (player.playing == false) {
      if (file.playing == 0) {
        filePlaying = file;
        await player
            .setAudioSource(AudioSource.uri(Uri.parse(file.audioLocal)));
        file.playing = 1;
