...
class ShopAuditState extends State<ShopAudit> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onPressed: () {show_log_att(); },
      child: Text('Log chấm công'),
    ), checkInOut(), secondLayout()],
          ),
        ));
  }
        ...
        content: Container(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return
                  Visibility(
                      visible: !controller.ProcessTakePhoto[index].isNullOrWhiteSpace(),
                      child: Row(
                        children: [
                          Expanded(
                              child: Container(
                                alignment: Alignment.centerLeft,
                                child: Text( (index+1).toString()+'/' + controller.ProcessTakePhoto.length.toString()+'. ' +controller.ProcessTakePhoto[index] ,
