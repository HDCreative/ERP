...
class DatabaseHelper {
  ...
  initDb() async {
    ...
    String dataPath =
        join(path, 'SyngentaAudit_' + user.employeeId.toString() + '.db');
  ...
  void _onCreate(Database db, int newVersion) async {
    ...
    try {
      await db.execute('CREATE TABLE IF NOT EXISTS ' +
          ...
          '(' +
          rowId +
          ', shopId INTEGER, shopName TEXT, address TEXT, contactName TEXT, phone TEXT, latitude DOUBLE  ,longitude DOUBLE  ,accuracy DOUBLE, photo TEXT, workDate INTEGER,'
    ...
    try {
      await db.execute('CREATE TABLE IF NOT EXISTS ' +
          ...
          '(' +
          rowId +
          ', workId INTEGER, productId INTEGER, osaValue INTEGER, comment TEXT)');
    } catch (ex) {
  ...
  static Future<String> getPath() async {
    ...
    return join(path, 'SyngentaAudit_' + user.employeeId.toString() + '.db');
  }
  ...
  openDB() async {
    ...
    return await openDatabase(
        join(path, 'SyngentaAudit_' + user.toString() + '.db'),
        version: version,
        onCreate: _onCreate);
  }
