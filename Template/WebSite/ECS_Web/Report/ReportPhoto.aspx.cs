    ...
    public partial class ReportPhoto : System.Web.UI.Page
    {
        ...
        private string getPhoto(string AuditID)
        {
            ...
            try
            {
                ...
                lstAtt.Add(new KPIsInfo("../images/product.jpg", "Tổng quan"));
                lstAtt.Add(new KPIsInfo("../images/product.jpg", "Sản phẩm 1"));
                lstAtt.Add(new KPIsInfo("../images/product.jpg", "Sản phẩm 2"));
                lstAtt.Add(new KPIsInfo("../images/product.jpg", "Sản phẩm 3"));
                lstAtt.Add(new KPIsInfo("../images/product.jpg", "Sản phẩm 4"));
