        ...
        marker.addListener('click', function () {
            ...
            var infowindow = new google.maps.InfoWindow({
                content: "<div id=\"content\">" +
                    ...
                    '<div id="bodyContent">' +
                    '<p>' +
                    '<b>ShopCode: </b>' + marker.data.ShopCode + '<br/>' +
                    '<b>Address: </b>' + marker.data.ShopAddress + '<br/>' +
                    '</p>' +
                    "<button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#modal-xl\" onclick=\"return view_report('" + marker.data.ShopCode + "')\" > Xem chi tiết </button>" +
                    //"<button onclick=\"return view_report('" + marker.data.ShopCode + "')\">Xem chi tiết</button>" +
                    //'<button onclick="return view_report(' + marker.data.ShopCode + ')">Xem chi tiết</button>' +
                    '</div>' +
                    '</div>'
            });
