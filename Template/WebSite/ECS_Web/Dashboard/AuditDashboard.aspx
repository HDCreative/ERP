...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function tab_audit() {
            ...
            // Auditresult
            Highcharts.chart('containerAuditSOSV2', {
                chart: { type: 'column' },
                title: { text: null },
                subtitle: { text: null },
                xAxis: {
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-primary card-outline card-tabs">
                <div class="card-header p-0 pt-1" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="card" style="height: 500px;">
                                        ...
                                        <div class="card-body">
                                            <div id="containerAuditSOSV2"></div>
                                        </div>
                                    </div>
                                </div>
