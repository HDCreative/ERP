...
namespace SyngentaAuditService.Data
{
    public class WorkPlanContext : DAUltility.DataContext
    {
        ...
        public DataSet Attendance_Action(int EmployeeId, int ShopId, int AttendanceType, double? latitude, double? longitude, double? Accuracy, string LinkPhoto,string  platform, string version, int ActionType)
        {
            return DAUltility.Helpers.SqlHelper.ExecuteDataset("[dbo].[AtendanceAction]", EmployeeId, ShopId, AttendanceType, latitude, longitude, Accuracy, LinkPhoto, platform,version, ActionType);
        }
