                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList runat="server" ID="ddlTypeReport" Style="width: 150px; height: 37px; float: right; margin-right: 20px;">
                                ...
                                <asp:ListItem Text="Tồn Kho" Value="9" />
                                <asp:ListItem Text="Bán Hàng" Value="10" />
                               <%-- <asp:ListItem Text="POSM" Value="3" />
                                <asp:ListItem Text="PXN" Value="4" />
                                <asp:ListItem Text="SURVEY OTHER" Value="5" />
                                <asp:ListItem Text="Báo cáo chi tiết" Value="6000" />--%>
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-4" id="div_lockwr" runat="server" style="display:none;">
                            <div class="row">
                                <div class="col-md-4">
                                                                                                ...
                                                                                                <ItemTemplate>
                                                                                                    <tr style="text-align: center;">
                                                                                                        ...
                                                                                                        <td style="vertical-align: bottom;"><%# Eval("TotalHours") %>
                                                                                                            <br />
                                                                                                            <a title="Xem bản đồ" style="cursor: pointer" onclick="popWindow('<%# "https://www.google.com/maps/search/" + Convert.ToString(Eval("LatitudeIn")) + "+" + Convert.ToString(Eval("LongitudeIn")) %>', 820, 635)">
                                                                                                                <img style="border: 1px solid red; height: 300px" src='<%# "https://maps.googleapis.com/maps/api/staticmap?center=" + Convert.ToString(Eval("LatitudeIn")) + "," + Convert.ToString(Eval("LongitudeIn")) +"&zoom=15&size=300x300&maptype=roadmap&markers=color:red%7Clabel:Shop%7C" + Convert.ToString(Eval("LatitudeIn")) + "," + Convert.ToString(Eval("LongitudeIn")) +"&key=AIzaSyAa8HeLH2lQMbPeOiMlM9D1VxZ7pbGQq8o" %>' />
                                                                                                            </a>
                                                                                                        </td>
