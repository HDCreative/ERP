...
<head>
    ...
    <title>PG Swisse | Log in (v2)</title>
...
<body class="hold-transition login-page" style="background-repeat: no-repeat; background-size: cover; background-position: 10%; position: fixed; z-index: -10000; top: 0; left: 0; right: 0; bottom: 0;">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                ...
                <img src="Images/logo_sw.png" style="padding: 10px;width:200px;" />
            ...
            <table style="text-align: center;">
                <tr>
                    <td>
                        <a href="https://pgsw.e-technology.vn/Services/Android/android.html">
                            <img src="Images/icon_android.png" style="width: 100px" /></a>

                    </td>
                    <td>
                        <%--<img src="Images/icon_ios.png" style="width:100px" />--%>
                        <a href="https://testflight.apple.com/join/mfTRcrTG">
