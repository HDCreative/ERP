<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportImageAdmin.aspx.cs" Inherits="VNPay_Web.Popups.ImportImageAdmin" %>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" CssClass="form-control select2 select2-hidden-accessible" ID="ddlKPI" OnSelectedIndexChanged="ddlType_SelectedIndexChanged" AutoPostBack="true">
                                                ...
                                                <asp:ListItem Text="Khảo sát lắp đặt POSM" Value="8" />
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
