    ...
    public partial class ImportImageAdmin : PagePermisstion
    {
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string LinkImage = UrlServices + "/Upload/import/tmpImport/" + UserCode + "/" + ImageName;
                error.Visible = false;
                ...
                if (System.IO.Directory.Exists(path))
                {
                    ...
                    {
                        string fullname_image_admin = root + UserCode + "/" + ImageName;
                        string dir1 = root + UserCode;
