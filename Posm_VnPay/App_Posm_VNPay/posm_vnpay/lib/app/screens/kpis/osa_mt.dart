...
import 'package:posm_vnpay/app/components/base_app_bar.dart';
import 'package:posm_vnpay/app/components/base_view_photo_dialog.dart';
import 'package:posm_vnpay/app/core/AppStyle.dart';
import 'package:posm_vnpay/app/core/Utility.dart';
...
import 'package:posm_vnpay/app/screens/kpis/osaComponents/searchSKU.dart';
import 'package:posm_vnpay/app/screens/kpis/surveyComponents/albumImages.dart';

import 'kpi_controller.dart';

class OsaMT extends StatefulWidget {
  @override
...
class OsaMTState extends State<OsaMT> {
         ...
         Container(
             ...
             child: Row(children: [
               ...
               Visibility( visible: ISOOS && !work.locked, child: TextButton(
                               ...
                               child: Text('Điền 0 tất cả số mặt'),)
                             ),
                    ...
                    children: [
                      Expanded(
                          ...
                          child: Row(children: [
                            ...
                            Container(
                              width: !item.value.segment.contains("SURVEY")?120:120,
                              child: Text(
                      ...
                      Visibility(
                          visible: !ExString(item.value.segment)
                                      .isNullOrWhiteSpace() //&& !item.value.segment.contains("SURVEY")
                              ? true
                              : false,
                          child: Expanded(
                              flex: 1,
                        ...
                        child: InkWell(
                          child: Text(
                            !ExString(item.value.productName)
                                    .isNullOrWhiteSpace()
                                ? (index+1).toString()+"/" +total.toString() +". "+ item.value.productName
                                : "SKU ko có tên.",
                            style: TextStyle(fontWeight: FontWeight.bold),
                          ),
                          onTap: () {
            ...
            Visibility(
              child: ConstrainedBox(
                ...
                child: Padding(
                    ...
                    child: Row(
                      children: [
                        // item.value.targetOSA != null && item.value.targetOSA > 0?
                        // Expanded(
                        //   flex: 1,
                        //   child: Text('Target: ${item.value.targetOSA}',
                                ...
                                onChanged: (String content) {
                                  Future.delayed(
                                    ...
                                    try {
                                      ...
                                      if(item.value.osaValue != null && item.value.osaValue<=0)
                                        {
                                        item.value.layerValue = null;
                                        item.value.layyer_textController.text = "";
                                        item.value.footValue = null;
                                        item.value.foot_textController.text = "";
                                        }
                                      await controller
                                          .updateDataOsa(
                                              work: work, item: item.value)
                        ...
                        Expanded(
                            ...
                            child: Obx(
                                  () => TextFormField(
                                controller: item.value.layyer_textController,
                                textAlign: TextAlign.center,
                                inputFormatters: <TextInputFormatter>[
                                  FilteringTextInputFormatter.digitsOnly
                                ],
                                ...
                                enabled: !work.locked && item.value.osaValue != null && item.value.osaValue > 0 ? true : false,
                                onChanged: (String content) {
                                  Future.delayed(
                                      new Duration(milliseconds: 500),
                                          () async {
                        ...
                        if(item.value.footid != null && item.value.footid >0)
                        Expanded(
                          flex: 2,
                          child: Text('Số chân: '),
                        ),
                        ...
                        Expanded(
                            ...
                            child: Obx(
                                  () => TextFormField(
                                controller: item.value.foot_textController,
                                textAlign: TextAlign.center,
                                inputFormatters: <TextInputFormatter>[
                                  FilteringTextInputFormatter.digitsOnly
                                ],
