...
import 'package:posm_vnpay/app/screens/kpis/kpi_promotion_controller.dart';
...
class PromotionState extends State<Promotion> {
  KPIPromotionController controller;
  ShopInfo shop;
  WorkResultInfo work;
  MasterInfo kpi;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      controller.getPromotionResult(shop, work, kpi);
    });
    super.initState();
  }
  ...
  Widget itemListView(
      BuildContext context, Rx<PromotionResultModel> item, int index) {
    return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        flex: 1,
                        child: Text(
                          'Tag giảm giá, t/tin c/trình, hàng tặng kèm có đẩy đủ ko? ',
                          style: TextStyle(fontSize: 12),
                        ),
                      ),
                      Expanded(
                              ...
                              Expanded(
                                  child: Obx(() => Theme(
                                      ...
                                      child: CheckboxListTile(
                                          ...
                                          value: item.value.value1 != null &&
                                              item.value.value1 == 1
                                              ? true
                                              : false,
                                          onChanged: !work.locked && item.value.value == 1
                                              ? (bool check) {
                                            if (!work.locked) {
                                              controller
                                                  .getUpdateDataPosm1(
