...
import 'package:posm_vnpay/app/base/MobileSupportInfo.dart';
import 'package:posm_vnpay/app/base/OsaInfo.dart';
import 'package:posm_vnpay/app/base/PosmInfo.dart';
import 'package:posm_vnpay/app/base/ProductInfo.dart';
import 'package:posm_vnpay/app/base/PromotionInfo.dart';
import 'package:posm_vnpay/app/base/SurveyAnswerInfo.dart';
import 'package:posm_vnpay/app/base/SurveyDetailInfo.dart';
import 'package:posm_vnpay/app/base/SurveyInfo.dart';
...
class DownloadController extends BaseController {
  ...
  void init() {
    ...
    lstDownload.add(new DownloadModle(
      ...
      name: 'Danh sách câu trả lời khảo sát',
    ));
    // lstDownload.add(new DownloadModle(
    //   id: 8,
    //   function: 'PRODUCTS',
