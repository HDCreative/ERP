...
import 'package:posm_vnpay/app/base/AudioInfo.dart';
import 'package:posm_vnpay/app/base/CoinCollectInfo.dart';
import 'package:posm_vnpay/app/base/EvaluateResultInfo.dart';
import 'package:posm_vnpay/app/base/MasterInfo.dart';
import 'package:posm_vnpay/app/base/OsaResultInfo.dart';
import 'package:posm_vnpay/app/base/PhotoInfo.dart';
import 'package:posm_vnpay/app/base/PosmResult.dart';
import 'package:posm_vnpay/app/base/PromotionResult.dart';
import 'package:posm_vnpay/app/base/SurveyAnswerInfo.dart';
import 'package:posm_vnpay/app/base/SurveyDetailResultInfo.dart';
import 'package:posm_vnpay/app/base/SurveyResultInfo.dart';
import 'package:posm_vnpay/app/base/UploadInfo.dart';
import 'package:posm_vnpay/app/base/UploadedItemInfo.dart';
import 'package:posm_vnpay/app/context/photoContext.dart';
import 'package:posm_vnpay/app/core/DateTimes.dart';
import 'package:posm_vnpay/app/data/DatabaseHelper.dart';
import 'package:posm_vnpay/app/data/TableNames.dart';
import 'package:posm_vnpay/app/extensions/ExsString.dart';
import 'package:posm_vnpay/app/models/AttendantInfo.dart';
import 'package:posm_vnpay/app/models/OsaResultModel.dart';
import 'package:posm_vnpay/app/models/PosmResultModel.dart';
import 'package:posm_vnpay/app/base/ShopInfo.dart';
import 'package:posm_vnpay/app/models/PromotionResultModel.dart';
import 'package:posm_vnpay/app/models/SurveyDetailResultModel.dart';
import 'package:posm_vnpay/app/models/SurveyResultModel.dart';
import 'package:posm_vnpay/app/models/WorkResultInfo.dart';
            ...
            if (kpi.id == 3) {
              ...
              if (lstTemp != null && lstTemp.length != 0) {
                for (PosmResultModel posm in lstTemp) {
                  ...
                  //   break;
                  // }
                  if (!ExString(posm.quantity.toString()).isNullOrWhiteSpace() && posm.quantity > 0) {
                    haveResult = 1;
                    break;
                  }
                }
                    ...
                    if (posm.value == 1) {
                      ...
                      if (lstPhotoByItem != null &&
                        ...
                        List<PhotoInfo> lstImg = lstPhotoByItem
                            ...
                            .toList();
                        if ((lstImg == null ||
                            (lstImg != null && lstImg.length == 0)) && posm.quantity > 0) {
                          kpi.kpiStatus = 1;
                          break;
                        }
                      } else {
