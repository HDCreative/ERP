...
using PosmVNPayService.Core;
using PosmVNPayService.Entities;
using System.Drawing;
using System.Data;
using System.ComponentModel;
using System.Linq;
using PosmVNPayService.Models;

namespace PosmVNPayService.Handlers
{
    public class UploadDataHandler : AuthorizationHandler
    {
        ...
        public override HttpResponseMessage AuthorizationRequest()
        {
            ...
            {
                if (Waiting == "1")
                    return HttpResponseMessage.CreateResponse(System.Net.HttpStatusCode.InternalServerError, "Waiting for Server!");
                try
                {
